                ...
                <tr class="product-item" data-id="${product.id}"
                    ...
                    <th style="width: 20%">
                        <img src="${product.getThumbnail()}" alt="${product.title}"
                             class="resized-image my-3" onclick="window.location.href = '/product?id=${product.id}'">
                    </th>
                    <th class="p-4">
                        <p class="title h6 fw-normal" onclick="window.location.href = '/product?id=${product.id}'">${product.title}</p>
                    </th>
                    <th class="p-4">
